...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Plugged.in — MCP Proxy & Claude Code Plugin for 2,700+ MCP Servers',
    template: '%s | Plugged.in'
  },
  description: 'Plugged.in is the universal MCP proxy and Claude Code plugin connecting 2,700+ Model Context Protocol servers. Use Cursor, Cline, ChatGPT, LM Studio, Windsurf, or Claude Code with one unified gateway, persistent memory, and embedded RAG. Free, open source.',
  keywords: [
    'MCP proxy',
    'MCP server',
    'MCP servers',
  ...
  openGraph: {
    ...
    title: 'Plugged.in — MCP Proxy & Claude Code Plugin for 2,700+ MCP Servers',
    description: 'Universal Model Context Protocol gateway. One MCP proxy, every client (Cursor, Cline, ChatGPT, LM Studio, Windsurf, Claude Code), 2,700+ MCP servers, persistent memory, embedded RAG. Free, open source.',
    siteName: 'Plugged.in',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Plugged.in — Universal MCP Proxy & Claude Code Plugin',
        type: 'image/png',
      }
    ],
  },
  twitter: {
    ...
    title: 'Plugged.in — MCP Proxy & Claude Code Plugin',
    description: 'Universal MCP proxy for Cursor, Cline, ChatGPT & LM Studio. 2,700+ MCP servers, collective memory, embedded RAG. Free, open source.',
    creator: '@pluggedin',
    site: '@pluggedin',
