...
export async function GET(
  ...
  try {
    ...
    // Only allow .jpg files (as all persona avatars are converted to jpg)
    ...
    // Persona avatars are stored in a personas subdirectory
    ...
    console.error('Error serving persona avatar:', error);
