...
export function AiSearchAnswer({ answer, sources = [], documentIds = [], isLoading, error, query, onDocumentClick }: AiSearchAnswerProps) {
              ...
              <div className="mt-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-sm font-medium text-muted-foreground">
                    {t('aiSearch.sources', 'Sources')} ({sources.length})
                  </span>
                </div>
