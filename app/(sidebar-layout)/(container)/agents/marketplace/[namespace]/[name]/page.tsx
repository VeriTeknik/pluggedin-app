...
import { AgentDeployWizard } from '@/components/agents/agent-deploy-wizard';
...
import { parseConfigurable } from '@/lib/agent-config';
import {
    ...
    try {
      ...
      const response = await fetch('/api/agents', {
        ...
        body: JSON.stringify({
          ...
          access_level: deployData.accessLevel,
          config_values: configurable ? deployData.configValues : undefined,
        }),
      });
      ...
      toast({
        ...
        description: `${data.template.display_name} has been deployed as "${deployData.name}".`,
      });
