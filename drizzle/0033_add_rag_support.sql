...
ALTER TABLE "playground_settings" ADD COLUMN IF NOT EXISTS "rag_enabled" boolean DEFAULT false NOT NULL;
...
CREATE INDEX IF NOT EXISTS "docs_project_uuid_idx" ON "docs" USING btree ("project_uuid");

CREATE INDEX IF NOT EXISTS "docs_name_idx" ON "docs" USING btree ("name");
