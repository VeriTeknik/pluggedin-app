...
UPDATE "memory_ring" SET "cbp_promoted" = true WHERE metadata::jsonb->>'cbp_promoted' = 'true';--> statement-breakpoint
UPDATE "memory_ring" SET "gut_processed" = true WHERE metadata::jsonb->>'gut_processed' = 'true';--> statement-breakpoint
