...
CREATE INDEX IF NOT EXISTS "server_reviews_source_external_id_idx" ON "server_reviews" USING btree ("server_source","server_external_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "server_reviews_user_id_idx" ON "server_reviews" USING btree ("user_id");