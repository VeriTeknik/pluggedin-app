...
CREATE INDEX IF NOT EXISTS "blog_post_translations_blog_post_idx" ON "blog_post_translations" USING btree ("blog_post_uuid");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "blog_post_translations_language_idx" ON "blog_post_translations" USING btree ("language");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "blog_posts_slug_idx" ON "blog_posts" USING btree ("slug");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "blog_posts_author_idx" ON "blog_posts" USING btree ("author_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "blog_posts_featured_idx" ON "blog_posts" USING btree ("is_featured");