ALTER TABLE "codes" ADD COLUMN IF NOT EXISTS "profile_uuid" uuid NOT NULL;--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "codes_profile_uuid_idx" ON "codes" USING btree ("profile_uuid");