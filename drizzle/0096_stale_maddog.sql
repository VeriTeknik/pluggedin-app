...
ALTER TABLE "dream_consolidations" ADD CONSTRAINT "dream_consolidations_profile_uuid_profiles_uuid_fk" FOREIGN KEY ("profile_uuid") REFERENCES "public"."profiles"("uuid") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "dream_consolidations" ADD CONSTRAINT "dream_consolidations_result_memory_uuid_memory_ring_uuid_fk" FOREIGN KEY ("result_memory_uuid") REFERENCES "public"."memory_ring"("uuid") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "individuation_snapshots" ADD CONSTRAINT "individuation_snapshots_profile_uuid_profiles_uuid_fk" FOREIGN KEY ("profile_uuid") REFERENCES "public"."profiles"("uuid") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "idx_dream_profile" ON "dream_consolidations" USING btree ("profile_uuid");--> statement-breakpoint
