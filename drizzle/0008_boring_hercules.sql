...
--> statement-breakpoint
ALTER TABLE "codes" ADD COLUMN IF NOT EXISTS "user_id" text NOT NULL;--> statement-breakpoint
ALTER TABLE "projects" ADD COLUMN IF NOT EXISTS "user_id" text NOT NULL;--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "codes_user_id_idx" ON "codes" USING btree ("user_id");--> statement-breakpoint
