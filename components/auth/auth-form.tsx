...
export function AuthForm({ type, defaultValues, onSuccess, returnTo }: AuthFormProps) {
    ...
    try {
      switch (type) {
        case 'login': {
          ...
          // On successful login
          window.location.href = returnTo || '/mcp-servers';
          if (onSuccess) {
            onSuccess();
          }
          break;
        ...
        <>
          ...
          <div className="grid gap-3">
            <Button 
              ...
              type="button"
              onClick={() => signIn('github', { callbackUrl: returnTo || '/mcp-servers' })}
            >
            ...
            <Button 
              ...
              className="bg-white hover:bg-zinc-50 dark:bg-zinc-900 dark:hover:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-800 transition-colors" 
              type="button"
              onClick={() => signIn('google', { callbackUrl: returnTo || '/mcp-servers' })}
            >
